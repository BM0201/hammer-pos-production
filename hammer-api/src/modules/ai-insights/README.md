...
Módulo de análisis inteligente para H.A.M.M.E.R. POS/ERP que genera insights accionables a partir de datos históricos de ventas, inventario y operaciones. Es un panel de sugerencias automatizadas que detecta patrones, anomalías y oportunidades de optimización.
...
- **Modelos utilizados:** `SaleOrder`, `SaleOrderLine`, `Product`, `InventoryBalance`, `InventoryMovement`, `Payment`, `Branch`, `User`
- **Clasificación ABC-XYZ** del módulo `src/modules/analytics/`

...
// La Content-Security-Policy NO vive aquí: la genera middleware.ts por
// request con un nonce único (script-src 'nonce-...' 'strict-dynamic',
// sin 'unsafe-inline' en producción). Aquí quedan solo los headers estáticos.

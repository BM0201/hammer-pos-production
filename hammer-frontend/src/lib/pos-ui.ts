...
const ERROR_MESSAGES_ES: Record<string, string> = {
  ...
  CASHIER_MODULE_DISABLED: "El módulo de caja no está habilitado en esta sucursal.",
  DIRECT_PAYMENT_DISABLED: "El cobro directo no está habilitado en esta sucursal.",
  PAYMENT_REFERENCE_REQUIRED: "Se requiere un número de referencia para pagos con tarjeta o transferencia.",
  CASH_SESSION_OPERATOR_REQUIRED: "No puedes cobrar porque no eres operador de la sesión de caja activa. Pide al cajero que te asigne como operador.",
  INVALID_TENDER_AMOUNT: "El monto del pago debe ser mayor que cero.",
  INVALID_CASH_RECEIVED_AMOUNT: "El monto recibido en efectivo no puede ser menor al total a cobrar.",
  INVALID_CASH_CHANGE_AMOUNT: "El cambio registrado no coincide con el monto recibido menos el total.",

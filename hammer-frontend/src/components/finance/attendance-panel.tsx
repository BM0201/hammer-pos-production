...
import { CalendarDays, CalendarX2, Loader2, ShieldCheck, Trash2 } from "lucide-react";
import toast from "react-hot-toast";
import { apiFetch, unwrapApiData } from "@/lib/client/api";
import { useSession } from "@/lib/client/session";
import { isMasterOrAbove } from "@/modules/rbac/role-routing";
import { fmtC, fmtDateShort, initials, round2 } from "./payroll-calc";
...
/** Mismos colores que "Pendientes de confirmar": un color por estado, consistente en toda Asistencia. */
...
/**
 * Calendario de asistencia (RRHH › Asistencia): un mes con quién vino cada
 * día, coloreado por estado — antes solo se veía el pase del día en curso,
 * sin forma de ver el historial de un vistazo.
 */
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-7 gap-1.5">
          ...
          {grid.map((date, i) => {
            ...
            return (
              <div key={i} className="min-h-[4rem] rounded-lg border border-[var(--color-border)] bg-[var(--color-surface-alt)] p-1">

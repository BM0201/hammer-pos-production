  ...
  return (
    <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] overflow-hidden">
      <div className="flex items-center justify-between px-4 py-3 border-b border-[var(--color-border)]">
        <div>
          <h3 className="text-sm font-semibold text-[var(--color-text)]">Movimientos de caja</h3>
          <p className="text-xs text-[var(--color-text-muted)]">Retiros, gastos y entradas de la sesión actual</p>
        </div>
        {canCreate && (
          <button
            type="button"
            className="rounded-lg bg-[var(--color-info-600)] hover:bg-[var(--color-info-700)] px-3 py-1.5 text-xs font-semibold text-white transition-colors"
            onClick={() => setOpen((v) => !v)}
          >
      ...
      {open && canCreate && (
        <div className="border-b border-[var(--color-border)] bg-[var(--color-surface-muted)] p-4 space-y-3">
          ...
          <div className="flex justify-end">
            <button
              type="button"
              className="rounded-lg bg-[var(--color-info-600)] hover:bg-[var(--color-info-700)] px-4 py-2 text-sm font-semibold text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              onClick={submit}
              disabled={submitting}
            >
